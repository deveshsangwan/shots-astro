...
- Host target: GitHub Pages custom domain `https://shots.deveshsangwan.com/`
...
4. Confirm `astro.config.mjs` has `site: "https://shots.deveshsangwan.com"` and no project base path.
5. Confirm `public/CNAME` contains `shots.deveshsangwan.com`.
